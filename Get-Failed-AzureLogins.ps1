...
$successful = $signIns | Where-Object { (!$_.status.errorCode -eq 0) } # I wanted to see unsuccessful logins but didn't want to change all the names :)
...
$filename = "~/Documents/" + $orgname.DisplayName + "_FailedNonIndianaLogins_" + $timestamp + ".csv"
